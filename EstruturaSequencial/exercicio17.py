...
print('----------------------------------------------------------------------------------------------')
area_a_ser_pintada = int(input ('Digite a área em metros quadrados a serem pintadas: ')) # area em metros quadrados
...
#Calculo com latas de 18 litros
litros_por_lata = 18
...
#calculo com galão de 3.6 litros
...
print (f'Você deverá usar {numero_de_latas} latas de 18 litros, mais {numero_de_galoes} galoes de 3.6 litros, no valor total de R$ {valor_total}')
